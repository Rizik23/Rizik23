...
🌍 Region: ${escapeHTML(orderData.spec.region.name)}`;
    ...
    const notificationText = `💰 <b>ORDER BERHASIL DIPROSES!</b>
...
📊 Total Pembelian User: Rp${toRupiah(buyerInfo.totalSpent)}`.trim();
    ...
    const contactButton = {
      text: "📞 Hubungi Buyer",
      url: buyerInfo.username ? `https://t.me/${buyerInfo.username}` : `tg://user?id=${buyerInfo.id}`
    };
        ...
        switch (command) {
            ...
            case "start": {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            [
                                { text: "🛍️ Katalog Produk", callback_data: "katalog", style: "primary" }
                            ], 
                            [
                            ...
                            [
                                { text: "📢 Testimoni", url: config.channelLink, style: "danger" }, 
                                { text: "📞 Developer", url: "https://t.me/"+config.ownerUsername, style: "danger" }
                            ]
                        ]
                    }
                });
...
bot.action("buyscript", async (ctx) => {
    ...
    scriptButtons.push([
        { text: "⏎ Kembali Ke Menu", callback_data: "katalog", style: "danger" }
    ]);
...
bot.action("buyapp", async (ctx) => {
    ...
    categoryButtons.push([
        { text: "⏎ Kembali Ke Menu", callback_data: "back_to_main_menu", style: "danger" }
    ]);
...
bot.action("back_to_main_menu", async (ctx) => {
    ...
    ctx.replyWithPhoto(config.menuImage, {
        caption: menuTextBot(ctx),
        parse_mode: "HTML",
        reply_markup: {
            inline_keyboard: [
 ...
 bot.action("katalog", async (ctx) => {
    ...
    const storeMenuKeyboard = {
        inline_keyboard: [
            [
                { text: "𝟭", callback_data: "buypanel" },
                { text: "𝟮", callback_data: "buyadmin" },
                { text: "𝟯", callback_data: "buyscript" }
            ],
            [
                { text: "𝟰", callback_data: "buyvps" },
                { text: "𝟱", callback_data: "buydo" },
                { text: "𝟲", callback_data: "buyapp" }
            ],
            [
                { text: "⏎ Kembali Ke Menu", callback_data: "back_to_main_menu", style: "danger" }
            ]
...
━━━━━━━━━━━━━━━━━━━━━━
[ 𝟭 ] ~ 📡 ☇ 𝗕𝘂𝘆 𝗣𝗮𝗻𝗲𝗹 𝗣𝘁𝗲𝗿𝗼𝗱𝗮𝗰𝘁𝘆𝗹
[ 𝟮 ] ~ 🌟 ☇ 𝗕𝘂𝘆 𝗔𝗱𝗺𝗶𝗻 𝗣𝗮𝗻𝗲𝗹
[ 𝟯 ] ~ 📁 ☇ 𝗕𝘂𝘆 𝗦𝗰𝗿𝗶𝗽𝘁 / 𝗕𝗮𝘀𝗲
[ 𝟰 ] ~ 🖥 ☇ 𝗕𝘂𝘆 𝗩𝗽𝘀 𝗗𝗶𝗴𝗶𝘁𝗮𝗹𝗢𝗰𝗲𝗮𝗻
[ 𝟱 ] ~ 🌐 ☇ 𝗕𝘂𝘆 𝗔𝗸𝘂𝗻 𝗗𝗶𝗴𝗶𝘁𝗮𝗹𝗢𝗰𝗲𝗮𝗻
[ 𝟲 ] ~ 📱 ☇ 𝗕𝘂𝘆 𝗔𝗽𝗽𝘀 𝗣𝗿𝗲𝗺𝗶𝘂𝗺
━━━━━━━━━━━━━━━━━━━━━━</blockquote>
<blockquote>🍂 𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗣𝗶𝗹𝗶𝗵 𝗣𝗿𝗼𝗱𝘂𝗸 𝗬𝗮𝗻𝗴 𝗜𝗻𝗴𝗶𝗻 𝗔𝗻𝗱𝗮 𝗢𝗿𝗱𝗲𝗿:</blockquote>
`,
        {
            parse_mode: "HTML",
        ...
        reply_markup: {
            inline_keyboard: [
                ...
                [
                    ...
                    { text: "⏎ Back Kategori", callback_data: "back_to_categories" }
                ]
            ]
        }
    });
        ...
        reply_markup: {
            inline_keyboard: [
                ...
                [
                    ...
                    { text: "⏎ Back Kategori", callback_data: "back_to_do_categories" }
                ]
            ]
        }
    });
...
⚠️ Apakah Anda yakin ingin melanjutkan pembayaran?
    ...
    await ctx.editMessageText(text, {
        ...
        reply_markup: {
            inline_keyboard: [
                [
                    { text: "✅ Konfirmasi", callback_data: `proceed_script_payment|${escapeHTML(sc.name)}` },
...
${lastTransactions}`;
        ...
        return ctx.editMessageText(profileText, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [contactButton],
                    [{ text: "⏎ Kembali", callback_data: "back_to_notification" }]
                ]
            }
        });
    });
